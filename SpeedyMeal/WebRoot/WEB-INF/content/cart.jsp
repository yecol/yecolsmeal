					...
					<div id="order_info" class="sidebar_block">
						...
						<table id="orderInfo">
							...
							<tr>
								...
								<td width="63">
									<form action="UserAction!addToCart.action" method="post">
						...
						<p class="navP">
							<a href="SearchAction!loginedList.action" class="n">重新选择商家</a>
						</p>
						<p class="navP">
							<a href="SearchAction!loginedList.action" class="n">继续在该店订餐</a>
						</p>
						<p class="navP">
							<a href="UserNavi!order.action" class="n">提交订单</a>
						</p>
					</div>
					<!--order_info-->
